...
HRESULT Device::InitDevice(BOOL isFullScreen, HWND hWnd, const int& iWinCX, const int& iWinCY)
{
	...
	d3dpp.Windowed = isFullScreen; //전체 화면 여부
